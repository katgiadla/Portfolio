...
# srv = pysftp.Connection(host=hostname, username=surname,
# password=password)
# srv.put(local_path,remote_path)
# fl = open(local_path, 'wb')

# sftp.put(local_path, remote_path, callback=None, confirm=True)
# print(sftp.listdir(path=os.path.dirname(remote_path)))
# sftp.close()
# stidn,stdout,stderr=client.exec_command("ls /home/stud/is2016" )
# for line in stdout:
# print("..."+line.strip("\n"))
