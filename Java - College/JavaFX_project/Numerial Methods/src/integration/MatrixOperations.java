...
public class MatrixOperations {
    ...
    public static void printMatrix (double[][] matrix, int id) {
        ...
        switch (id) {
            case 1:
                System.out.print (MessageFormat.format ("First [{0}][{1}]:", rows, cols));
                break;
            case 2:
                System.out.print (MessageFormat.format ("Second [{0}][{1}]:", rows, cols));
                break;
            case 3:
                System.out.print (MessageFormat.format ("Result[{0}][{1}]:", rows, cols));
                break;
            case 4:
                System.out.print (MessageFormat.format ("Inverted [{0}][{1}]:", rows, cols));
                break;
            default:
